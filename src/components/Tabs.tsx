    ...
    <div className={cn('flex bg-gray-100/50 dark:bg-gray-800/50 p-1 rounded-2xl border border-gray-100 dark:border-gray-700', className)}>
      {tabs.map((tab) => (
        <button
          ...
          className={cn(
            'flex-1 flex flex-row items-center justify-center gap-1.5 sm:gap-2 py-2.5 sm:py-3 px-2 sm:px-4 rounded-xl text-[11px] sm:text-sm font-medium transition-all whitespace-nowrap',
            activeTab === tab.id
