            ...
            {subject.room && (
              <div className="flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400">
                ...
                <button 
                  ...
                  className="ml-auto p-1 bg-blue-50 dark:bg-blue-900/30 text-blue-500 dark:text-blue-400 rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors shrink-0"
                  title="Xem bản đồ"
                >
