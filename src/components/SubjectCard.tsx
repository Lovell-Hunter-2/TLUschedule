            ...
            {subject.room && (
              <div className="flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400">
                ...
                <button 
                  ...
                  className="p-1.8 sm:p-2 ml-1.5 bg-blue-100/50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400 rounded-lg shadow-sm hover:bg-blue-200/60 dark:hover:bg-blue-900/60 hover:scale-105 active:scale-95 transition-all shrink-0"
                  title="Xem bản đồ"
                >
